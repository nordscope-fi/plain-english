...
export function renderWritingStyle(set: RuleSet): string {
  ...
  // Both readability rules ship `link: ...writing-style.md#readability`, so
  // this section is what that anchor resolves to. Without it every readability
  // finding printed a dead link.
